...
namespace Protocolo {
  ...
  constexpr const char* RESPUESTA = "respuesta";
  constexpr const char* DATA = "data";
  constexpr const char* ESTADO = "estado";
  constexpr const char* COMANDO_ORIGINAL = "comando_original";
  ...
  constexpr const char* MARCAR_PLATO_LISTO = "MARCAR_PLATO_LISTO";
